...
| 전류 모니터 | **INA226 + 1mΩ shunt** (옵션) | MCU에서 입력 전류 모니터링 |
...
## 4-10. 사이즈 / 폼팩터 예산 (모터 15A+ 반영, v2.6)
...
| × 1.5 (라우팅·간격·30A 트레이스) | **~3200 mm²** | |

**수정 목표 보드 (v2.6, 15A+ 모터 반영):**
- **1차 (안전·추천):** **60 × 60 mm = 3600 mm²** · 4-layer · 2oz 외층 동박
- **공격적:** 55 × 55 mm = 3025 mm² · 6-layer · 양면 실장 + 2oz
- **참고:** Moteus r4.5 = 46×53mm (모터 드라이버 내장 단일보드라 우리보다 작음)
...
| 항목 | 옵션 | 권장 |
|---|---|---|
| MCU 패키지 (재확인) | LQFP100 (추천) / BGA UFBGA100 (외주 조립이라도 추천 X — §2 분석) | LQFP100 |
| eFuse | **LTC4368-1 확정 권장** (24~48V 대응, latch 모드) | 포함 |
| 입력 커넥터 | **XT60** (30A) / XT90 (45A 더 안전) | XT60 |
| 모터 출력 커넥터 | XT30 (15A 마진 0) / **XT60** (30A 마진 충분) | XT30 OK or XT60 안전 |
| 사이즈 | **60×60 4L (1차)** / 55×55 6L (공격적) | 60×60 4L |
| PCB 동박 | 1oz / **2oz** | 2oz (30A 트레이스) |
| CubeMX 칩 | H723VGT6 진행 OK? | 사용자 확인 |
| 모터 모델·전압 (Phase 5) | Elmo 모델 + 24/36/48V | 모터 확정 후 |
