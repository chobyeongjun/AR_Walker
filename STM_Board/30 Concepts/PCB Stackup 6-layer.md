...
> ✅ **Layer 수 6-layer 는 사용자 확정** (2026-04-20).
> ⏸️ 보드 사이즈 구체 수치는 [[Size Budget]] 참고 — 모터 확정 후 P6 단계 결정.

## 문제

4-layer 60×60mm 와 6-layer (더 작게) 어느 쪽이 나은가?
사용자 요청: **layer ↑ 로 사이즈 ↓ + 성능·안전** (2026-04-20 세션).
