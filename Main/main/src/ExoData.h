...
public:
        ...
        uint16_t battery_value; /**< Could be Voltage or SOC, depending on the battery type*/
        ...
        // 나중에 Gui로 구현하고 수정해야 함.
        float left_knee_reference_force = 10.0f;   /**< Reference force for left knee admittance control (N) */
        float right_knee_reference_force = 10.0f;  /**< Reference force for right knee admittance control (N) */
        float left_ankle_reference_force = 10.0f;  /**< Reference force for left ankle admittance control (N) */
        float right_ankle_reference_force = 10.0f; /**< Reference force for right ankle admittance control (N) */
