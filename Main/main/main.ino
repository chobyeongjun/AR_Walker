...
// #include "src/ParamsFromSD.h" // Removed - using hardcoded controller parameters
...
=
        ...
        if (exo_data.left_side.knee.is_used)
        {
            ...
            //Handles desired operations if in headless mode
                ...
                // Controller parameters are now hardcoded - no SD card loading needed
                // set_controller_params removed - using hardcoded Admittance Control parameters
