...
/**
 * @brief Class used to interface with a Loadcell sensor
 */
class Loadcell
{
public:
     ...
     *
     * @return the calibrated Loadcell reading
     */
    float read();
     ...
     *
     * @return Loadcell calibration offset
     */
    float readOffset();
     ...
     * @brief Reads the pin and returns the calibrated value.
     *
     * @return the calibrated Loadcell reading (offset pulled from the SD card)
     */
...
private:
    ...
    float _calibration;                /**< Stores the value used for calibration. This is a zero Loadcell offset*/
    float _calibrated_reading;         /**< Loadcell value with offset applied */
    float _calibrated_reading_microSD; /**< Loadcell value with offset (pulled from the SD Card) applied */
