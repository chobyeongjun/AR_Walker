...
namespace status_defs
{
    namespace messages
    {
        ...
        const uint16_t loadcell_calibration = 4;
        const uint16_t imu_start = 5;
        const uint16_t imu_stop = 6;
        ...
        const uint16_t error_left_ankle_imu = 5 << error_bit | error;
        const uint16_t error_right_ankle_imu = 6 << error_bit | error;
        const uint16_t error_left_knee_imu = 7 << error_bit | error;
        const uint16_t error_right_knee_imu = 8 << error_bit | error;

        const uint16_t error_left_knee_motor = 9 << error_bit | error;    /**< Left knee motor error id */
        const uint16_t error_right_knee_motor = 10 << error_bit | error;  /**< Right knee motor error id */
        const uint16_t error_left_ankle_motor = 11 << error_bit | error;  /**< Left ankle motor error id */
        ...
        const uint16_t error_right_knee_controller = 14 << error_bit | error;  /**< Right knee controller error id */
        const uint16_t error_left_ankle_controller = 15 << error_bit | error;  /**< Left ankle controller error id */
